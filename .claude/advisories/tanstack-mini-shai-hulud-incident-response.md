...
pnpm 11 ships two security defaults that directly mitigate this advisory. See the `package-manager` skill (`.claude/skills/package-manager/SKILL.md`) for the full policy.
